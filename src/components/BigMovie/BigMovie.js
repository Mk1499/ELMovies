        ...
        return (
            <View style={styles.bigMovie}>
                ...
                <View style={styles.bigMovieData}>
                    <Text numberOfLines={2} ellipsizeMode='tail' style={styles.bigMovieTitle}>{this.props.movie.title|| this.props.movie.original_name}</Text>
                    ...
                    <Text numberOfLines={3} ellipsizeMode='tail' style={styles.bigMovieDesc}>{this.props.movie.overview}</Text>
